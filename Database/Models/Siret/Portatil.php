...
class Portatil extends abstractModel
{
    ...
    public function getById()
    {
        ...
        $query = $this->Connection->prepare("SELECT * FROM portatil WHERE idportatil = ?");
    ...
    public function create()
    {
        ...
        try {
            $this->getInstance();
            $query = $this->Connection->prepare("INSERT INTO portatil VALUES (null, ?,?,?,?,?,?)");
    ...
    {
        $this->getInstance();
        $query = $this->Connection->prepare("UPDATE portatil SET codigo = ?, serial = ?,
         descripcion = ?, estado = ?, fecha = ?, activo = ? WHERE idportatil = ?");
        $query->bindParam(1, $this->getCodigo());
        $query->bindParam(2, $this->getSerial());
        $query->bindParam(3, $this->getDescripcion());
        $query->bindParam(4, $this->getEstado());
    ...
    {
        $this->getInstance();
        $query = $this->Connection->prepare("UPDATE portatil SET activo = ? WHERE idportatil = ?");

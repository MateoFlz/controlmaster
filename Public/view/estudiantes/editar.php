    ...
    <div class="card border-secondary mb-3">
        <div class="card-header bg-light">
            <div type="button" class="btn-group float-md-right">
                <a class="btn btn-info" href="<?php echo URL . 'estudiantes' ?>"><i
        ...
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate action="<?php echo URL; ?>estudiantes/edit_student" method="post">
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control input-sm" id="idcedulaedit" name="idcedulaedit"
                            value="<?php echo $row['cedula']; ?>" pattern="{11}" title="once(11) o menos, solo numero"
                            placeholder="Numero de cédula" required readonly>
                    </div>

                    <div class="col-md-4">
                        <label for="idnombre1edit" class="control-label">Primer nombre</label>
                        <input type="text" class="form-control input-sm" id="idnombre1edit" name="idnombre1edit"
                            onkeydown="return false" value="<?php echo $row['pnombre']; ?>" pattern="[a-zA-Z]{,40}"
                            placeholder="Primer nombre" required>
                    </div>

                    <div class="col-md-4">
                        <label for="idnombre2edit" class="control-label">Segundo nombre</label>
                        <input type="text" class="form-control input-sm" id="idnombre2edit" name="idnombre2edit"
                            value="<?php echo $row['snombre']; ?>" placeholder="Segundo nombre">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control input-sm" id="idapellido1edit" name="idapellido1edit"
                            value="<?php echo $row['papellido']; ?>" placeholder="Primer apellido" required>
                    </div>

                    <div class="col-md-4">
                        <label for="idapellido2edit" class="control-label">Segundo apellido</label>
                        <input type="text" class="form-control input-sm" id="idapellido2edit" name="idapellido2edit"
                            value="<?php echo $row['sapellido']; ?>" placeholder="Segundo apellido">
                    </div>

                    <div class="col-md-4">
                        <label for="idtelefono2edit" class="control-label">Telefono</label>
                        <input type="number" class="form-control input-sm" id="idtelefono2edit" name="idtelefonoedit"
                            value="<?php echo $row['telefono']; ?>" placeholder="Numero telefonico" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control input-sm" id="idCorreoedit" name="idCorreoedit"
                            value="<?php echo $row['correo']; ?>" placeholder="Correo electronico" required>
                    </div>

                    <div class="col-md-6">
                        <label for="idDireccionedit" class="control-label">Dirección</label>
                        <input type="text" class="form-control input-sm" id="idDireccion" name="idDireccionedit"
                            value="<?php echo $row['direccion']; ?>" placeholder="Dirección de residencia" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-5">
                        ...
                        <select class='form-control input-sm' id="condiciones1edit" name="condiciones1edit"
                            value="<?php echo $row['semestre']; ?>" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <select class='form-control input-sm' id="condicione3sedit" name="condiciones3edit" required>
                            ...
                            ?>
                            <option value="<?php echo $rows['id']; ?>" selected><?php echo $rows['nombreprograma']; ?>
                            </option>';
                            <?php
                                } else {
                                ?>
                ...
                <div class="form-group row justify-content-center">
                    <button type="button" class="btn btn-warning btn-lg"><i
                            class="fas fa-fingerprint"></i><br>Huella</button>
                </div>
                <div class="dropdown-divider"></div>
            ...
            <?php
                ...
                ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                Usted no cuenta con privilegio para editar estudiante!
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

    ...
    <div class="card border-secondary mb-3">
        ...
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate role="form" id=""
                action="<?php echo URL; ?>estudiantes/insert_student" method="post">
                <div class="form-group row">

                    <div class="col-md-4">
                        <label for="idcedula" class="control-label">Cédula</label>
                        <input type="number" class="form-control input-sm" id="idcedula" name="idcedula" pattern="{11}"
                            title="once(11) o menos, solo numero" placeholder="Numero de cédula" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control input-sm" id="idnombre1" name="idnombre1"
                            pattern="[a-zA-Z]{,40}" placeholder="Primer nombre" required>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <select class='form-control input-sm' id="condiciones2" name="condiciones2" required>
                            ...
                            ?>
                            <option value="<?php echo $row['id']; ?>"><?php echo $row['nombreprograma']; ?></option>';
                            <?php
                            }
                            ?>
            ...
            <?php
                ...
                ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                Usted no cuenta con privilegio para crear estudiante!
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

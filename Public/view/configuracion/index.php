...
<div class="container-fluid pt-4 " style="max-width: 85rem;">
    <div class="card border-secondary mb-3" >
        ...
        <div class="card-body d-flex align-content-end flex-wrap justify-content-center" >
            <div class="card text-center" style="min-width: 100%; min-height: 25rem">
                <div class="card-header bg-light">
                    ...
                    <div class="tab-content" id="myTabContent">
                                ...
                                <div class="modal-dialog modal-xl" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel">Agregar administrador de sistema</h5>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form role="form" id="formadmin">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="number" class="form-control input-sm" id="iddcedula" placeholder="Numero de cédula" required>
                                                    </div>
                                                    <label for="iddnombre1" class="col-md-1 control-label">Primer nombre</label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control input-sm" id="iddnombre1" placeholder="Primer nombre">
                                                    </div>
                                                    <label for="iddnombre2" class="col-md-1 control-label">Segundo nombre</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control input-sm" id="iddnombre2" placeholder="Segundo nombre">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="iddapellido1" class="col-md-1 control-label">Primer apellido</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control input-sm" id="iddapellido1" placeholder="Primer apellido">
                                                    </div>
                                                    <label for="iddapellido2" class="col-md-1 control-label">Segundo apellido</label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control input-sm" id="iddapellido2" placeholder="Primer apellido">
                                                    </div>
                                                    <label for="iddtelefono" class="col-md-1 control-label">Telefono</label>
                                                    <div class="col-md-3">
                                                        <input type="number" class="form-control input-sm" id="iddtelefono" placeholder="Numero telefonico">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="iddcorreo" class="col-md-1 control-label">Correo</label>
                                                    <div class="col-md-5">
                                                        <input type="email" class="form-control input-sm" id="iddcorreo" placeholder="Correo electronico" required>
                                                    </div>
                                                    <label for="iddireccion1" class="col-md-2 control-label">Dirección recidencial</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control input-sm" id="iddireccion1" placeholder="Dirección de residencia">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="idcondiciones1" class="col-md-1 control-label">Estado</label>
                                                    <div class="col-md-5">
                                                        <select class='form-control input-sm' id="idcondiciones1" required>
                                                ...
                                                <hr>
                                                <div class="form-group row">
                                                    <label for="idcondiciones2" class="col-md-1 control-label">Usuario</label>
                                                    <div class="col-md-4">
                                                        <select class='form-control input-sm' id="idcondiciones2" required>
                                                            <option value="">-- Selecciona un tipo de usuario --</option>
                                                            <option value="Administrador">Administrador</option>
                                                            <option value="Tecnico">Tecnico</option>
                                                        </select>
                                                    </div>
                                                    <label for="idpasswords" class="col-md-2 control-label">Contraseña de acceso</label>
                                                    <div class="col-md-4">
                                                        <input type="password" class="form-control input-sm" id="idpasswords" placeholder="Digite su contraseña" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <form class="" role="form" id="searchprogram">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Programa</strong></label>
                                    <div class="col-md-7">
                                        <input type="text" id="programsearch" class="form-control" placeholder="Id o programa">
                                    </div>
                                    <div class="col-md-2">
                            ...
                            <div class="btn-group align-items-center" type="button" class="">
                                <button type="button" class="btn-open btn btn-success" data-toggle="modal" data-target="#staticBackdrop2">
                            ...
                            <div class="modal fade" id="staticBackdrop2" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body ">
                                            <div id="programsuccess" class="alert alert-success alert-dismissible fade show" role="alert">
                                            ...
                                            <form id="formprogram" class="pt-0">
                                                <div class="form-row">
                                                    <div class="col">
                                                        <input type="text" class="form-control" id="nameprogram" placeholder="Nombre del programa">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                                    <button type="submit" class="btn btn-success" id="successProgram">Guardar</button>
                                                </div>
                                            </form>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="profile-tab">
                            <form class="" role="form" id="searchdependencia">
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label"><strong>Dependencia</strong></label>
                                    <div class="col-md-7">
                                        <input type="text" id="dependenciasearch" class="form-control" placeholder="Id o dependencia">
                                    </div>
                                    <div class="col-md-2">
                                        <button type="button" class="btn btn-light border">Buscar</button>
                                    </div>
                            ...
                            <div class="btn-group align-items-center" type="button" class="">
                                <button type="button" class="btn-open-depe btn btn-success" data-toggle="modal" data-target="#staticBackdrop3">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="formdependencia">
                                            <div class="modal-body">
                                            <div id="dependencesuccess" class="alert alert-success alert-dismissible fade show" role="alert">
                                                Dependencia guardado satifactoriamente
                                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                                </button>
                                            </div>
                                            <div id="dependencedanger" class="alert alert-danger alert-dismissible fade show" role="alert">
                                                ...
                                                <div class="form-row">
                                                    <div class="col">
                                                        <input type="text" id="namedependencia" class="form-control" placeholder="Nombre dependencia">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="" role="form" id="">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <input type="number" class="form-control input-sm" id="idcedula" placeholder="Numero de cédula" required>
                                                    </div>
                                                    <label for="idnombre1" class="col-md-1 control-label">Primer nombre</label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control input-sm" id="idnombre1" placeholder="Primer nombre">
                                                    </div>
                                                    <label for="idnombre2" class="col-md-1 control-label">Segundo nombre</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control input-sm" id="idnombre2" placeholder="Segundo nombre">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="idapellido1" class="col-md-1 control-label">Primer apellido</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control input-sm" id="idapellido1" placeholder="Primer apellido">
                                                    </div>
                                                    <label for="idapellido2" class="col-md-1 control-label">Segundo apellido</label>
                                                    <div class="col-md-2">
                                                        <input type="text" class="form-control input-sm" id="idapellido2" placeholder="Primer apellido">
                                                    </div>
                                                    <label for="idtelefono" class="col-md-1 control-label">Telefono</label>
                                                    <div class="col-md-3">
                                                        <input type="number" class="form-control input-sm" id="idtelefono" placeholder="Numero telefonico">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="idcorreo" class="col-md-1 control-label">Correo</label>
                                                    <div class="col-md-5">
                                                        <input type="email" class="form-control input-sm" id="idcorreo" placeholder="Correo electronico" required>
                                                    </div>
                                                    <label for="iddireccion" class="col-md-2 control-label">Dirección recidencial</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control input-sm" id="iddireccion" placeholder="Dirección de residencia">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                ...
                                                <hr>
                                                <div class="form-group row">
                                                    <label for="nombre_cliente" class="col-md-1 control-label">Usuario</label>
                                                    <div class="col-md-4">
                                                    ...
                                                    <label for="idpassword" class="col-md-2 control-label">Contraseña de acceso</label>
                                                    <div class="col-md-4">
                                                        <input type="password" class="form-control input-sm" id="idpassword" placeholder="Digite su contraseña" required autocomplete="off">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>

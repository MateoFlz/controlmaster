        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle active text-white" id="navbarDropdown" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href=""><i
                            class="fas fa-user-plus"></i> Usuarios<span class="sr-only">(current)</span></a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?php echo URL . 'estudiantes'?>"><i
                                class="fas fa-user-graduate"></i> Estudiantes</a>
                        <a class="dropdown-item" href="<?php echo URL . 'docentes'?>"><i
                                class="fas fa-chalkboard-teacher"></i> Docentes</a>
                        <a class="dropdown-item" href="<?php echo URL . 'administrativos'?>"><i
                                class="fas fa-user-tie"></i> Administrativos</a>
                        <a class="dropdown-item" href="<?php echo URL . 'invitados'?>"><i class="fas fa-user"></i>
                            Invitado</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?php echo URL . 'inventarios/index'?>"><i
                                class="fas fa-boxes"></i> Inventario</a>
                        <a class="dropdown-item" href="<?php echo URL . 'prestamos/index'?>"><i
                                class="fas fa-hand-holding"></i> Prestamos</a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?php echo URL . 'inventarios/laboratorios/index'?>"><i
                                class="fas fa-boxes"></i> Inventario</a>
                        <a class="dropdown-item" href="<?php echo URL . 'inventarios/laboratorios/reservas'?>"><i
                                class="fas fa-calendar-check"></i> Reservas</a>
            ...
            <ul class="navbar-nav mr-5">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?php echo URL . 'perfil'?>"><i class="fas fa-user"></i>
                            Perfil</a>
                            <a href="" id="btnGroupDro" class="dropdown-item dropdown-toggle" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <a class="dropdown-item" href="<?php echo URL . 'index/logout'?>"><i

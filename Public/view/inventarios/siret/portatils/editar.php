<div class="col-md-4">
    <div class="card">
        ...
        <div class="card-body">
            <?php
            $row = $datos['portatilforid']->fetchAll(\PDO::FETCH_ASSOC);
            $codigo = explode('-', $row[0]['codigo']);
            if (strpos($fullUrl, "responsedit=true") ==  true) { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    Portatil actualizado satifactoriamente.
            ...
            if (strpos($fullUrl, "responsedit=false") ==  true) { ?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    Ocurrio un error al actualizar el portail.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            ?>
            <form action="<?php echo URL . "inventarios/siret/portatil/update/" . $row[0]['idportatil']; ?>" method="post">
                <input type="hidden" name="idportatil" value="<?php echo $row[0]['idportatil']?>">
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="date" class="form-control input-sm" id="idfecha" name="idfecha" value="<?php echo $row[0]['fecha']?>" placeholder="Segundo nombre">
                    </div>
                    <div class="col-md-12">

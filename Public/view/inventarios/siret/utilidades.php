...
<div class="container-fluid pt-4">
    <div class="card border-secondary mb-3">
        ...
        <div class="card-header bg-light">
            ...
            <h5 class="text-dark">Lista de utilidades registradas</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <?php
                if (strpos($fullUrl, "editar") !=  true) {
                    include_once 'utilidades/crear.php';
                } else {
                    include_once 'utilidades/editar.php';
                }
                ?>
                <div class="col-md-8">
                    <div class="card">
                        ...
                        if (strpos($fullUrl, "delete=true") ==  true) { ?>
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                utilidad eliminado satifactoriamente.
                                        ...
                                        ?>
                                                <tr <?php echo 'respon="' . $row['idutilida'] . '"' ?>>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="<?php echo URL . "inventarios/siret/utilidades/editar/" . $row['idutilida']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                                                        <form action="<?php echo URL . "inventarios/siret/utilidades/delete/" . $row['idutilida']; ?>" method="post" style="display: inline">

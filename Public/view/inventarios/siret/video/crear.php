        ...
        <div class="card-body">
            ...
            if (strpos($fullUrl, "response=true") ==  true) { ?>
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    Video beam guardado satifactoriamente.
            ...
            if (strpos($fullUrl, "response=false") ==  true) { ?>
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    Ocurrio un error al guardar el Video beam.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            ...
            ?>
            <form action="<?php echo URL . "inventarios/siret/insert_video"; ?>" method="post">
                <div class="form-group row">
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <input type="text" class="form-control" name="cod1" value="VBM-" readonly required>
                            </div>
                            <div class="col">

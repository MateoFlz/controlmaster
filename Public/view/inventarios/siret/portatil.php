...
<div class="container-fluid pt-4">
    <div class="card border-secondary mb-3">
        ...
        <div class="card-header bg-light">
            ...
            <h5 class="text-dark">Lista registro de portatil</h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                if (strpos($fullUrl, "editar") !=  true) {
                    include_once 'portatils/crear.php';
                } else {
                    include_once 'portatils/editar.php';
                }
                ?>
                                        ...
                                        ?>
                                                <tr <?php echo 'respon="' . $row['idportatil'] . '"' ?>>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a href="<?php echo URL . "inventarios/siret/portatil/editar/" . $row['idportatil']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                                                        <form action="<?php echo URL . "inventarios/siret/portatil/delete/" . $row['idportatil']; ?>" method="post" style="display: inline">

    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo URL . "inventarios/update"; ?>" method="post">
                <input type="hidden" name="idportatil" value="<?php echo $rowt[0]['id']?>">
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <label for="ubicacionedit" class="control-label">Aulas</label>
                        <select name="ubicacionedit" id="ubicacionedit" class="form-control" required>
                            <option value=""> -- : -- -- </option>
                        </select>
                    </div>
                    <script>

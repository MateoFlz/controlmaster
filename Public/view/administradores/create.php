    ...
    <div class="card border-secondary mb-3">
        ...
        <div class="card-body">
            ...
            if ($_SESSION['crear'] == 1) {
                ...
                ?>
                <form class="needs-validation" novalidate role="form" id="" action="<?php echo URL; ?>administradores/insert_administrador" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <label for="idpasswords" class="control-label">Contraseña
                                de acceso</label>
                            <input type="password" class="form-control input-sm" name="idpasswords" id="idpasswords" placeholder="Digite su contraseña" required autocomplete="off">
                        </div>
                    </div>
...
?>
    <div class="alert alert-danger alert-dismissible fade show" role="alert">
        Usted no cuenta con privilegio para crear administradores!
        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times;</span>
        </button>
    </div>

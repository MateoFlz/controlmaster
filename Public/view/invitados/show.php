    ...
    <div class="card border-secondary mb-3">
        ...
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate action="<?php echo URL; ?>invitados/edit" method="post">
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control input-sm" id="idnombre2edit" name="idnombre2edit" value="<?php echo $row['snombre']; ?>" onkeydown="return false" placeholder="Segundo nombre">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control input-sm" id="idapellido1edit" name="idapellido1edit" value="<?php echo $row['papellido']; ?>" onkeydown="return false" placeholder="Primer apellido" required>
                    </div>

                    <div class="col-md-4">
                        <label for="idapellido2edit" class="control-label">Segundo apellido</label>
                        <input type="text" class="form-control input-sm" id="idapellido2edit" name="idapellido2edit" value="<?php echo $row['sapellido']; ?>" onkeydown="return false" placeholder="Segundo apellido">
                    </div>

                    <div class="col-md-4">
                        <label for="idtelefono2edit" class="control-label">Telefono</label>
                        <input type="number" class="form-control input-sm" id="idtelefono2edit" name="idtelefonoedit" value="<?php echo $row['telefono']; ?>" onkeydown="return false" placeholder="Numero telefonico" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="email" class="form-control input-sm" id="idCorreoedit" name="idCorreoedit" value="<?php echo $row['correo']; ?>" onkeydown="return false" placeholder="Correo electronico" required>
                    </div>

                    <div class="col-md-4">
                        <label for="idDireccionedit" class="control-label">Dirección</label>
                        <input type="text" class="form-control input-sm" id="idDireccionedit" name="idDireccionedit" value="<?php echo $row['direccion']; ?>" onkeydown="return false" placeholder="Dirección de residencia" required>
                    </div>
                    <div class="col-md-12">
                    <label for="condiciones3edit" class="control-label">Descripcion</label>
                        <textarea class="form-control" name="descripcionedit" id="exampleFormControlTextarea1" rows="2" onkeydown="return false" ><?php echo $row['detalles']; ?></textarea>
                    </div>
            ...
            <?php
                ...
                ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                Usted no cuenta con privilegio para ver datos del invitados!
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

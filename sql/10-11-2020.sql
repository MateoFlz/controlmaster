...
CREATE TABLE IF NOT EXISTS `prestamo_equipo` (
  `id` int(15) NOT NULL AUTO_INCREMENT,
  `idprestamo` int(15) NOT NULL DEFAULT 0,
  ...
  KEY `FK_prestamo_equipo_prestamo` (`idprestamo`),
  CONSTRAINT `FK_prestamo_equipo_equipos` FOREIGN KEY (`equipo_id`) REFERENCES `equipos` (`id`),
  CONSTRAINT `FK_prestamo_equipo_prestamo` FOREIGN KEY (`idprestamo`) REFERENCES `prestamo` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
...
-- Volcando datos para la tabla contro_siret.tmp_equipo: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `tmp_equipo` DISABLE KEYS */;
INSERT INTO `tmp_equipo` (`id`, `id_equipo`, `serial`, `marca`, `descripcion`, `tipo`, `fecha`, `admin`) VALUES
	(63, 6, '3574ST', 'EPSON', 'Nuevo con garantia', 'Video', '2020-11-10', 1),
	(64, 3, 'DATD', 'HP', 'Nuevo', 'Portatil', '2020-11-10', 1);
...
-- Volcando datos para la tabla contro_siret.tmp_utilidad_id: ~1 rows (aproximadamente)
...
INSERT INTO `utilidades` (`id`, `etiqueta_id`, `marca`, `descripcion`, `ubicacion`, `cantidad`, `estado`, `activo`) VALUES
	...
	(2, 3, 'PRO', 'Consequat Con sonido', 1, 4, 'Bueno', 1);

...
-- Volcando datos para la tabla contro_siret.tmp_equipo: ~1 rows (aproximadamente)
...
-- Volcando datos para la tabla contro_siret.tmp_utilidad_id: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla contro_siret.utilidades: ~1 rows (aproximadamente)
...
INSERT INTO `utilidades` (`id`, `etiqueta_id`, `marca`, `descripcion`, `ubicacion`, `cantidad`, `estado`, `activo`) VALUES
	...
	(2, 3, 'PRO', 'Consequat Con sonido', 1, 3, 'Bueno', 1);

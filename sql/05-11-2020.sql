...
-- Volcando datos para la tabla contro_siret.equipos: ~4 rows (aproximadamente)
...
-- Volcando estructura para tabla contro_siret.tmp
CREATE TABLE IF NOT EXISTS `tmp` (
  `id` int(15) NOT NULL AUTO_INCREMENT,
  `id_usuario` int(15) DEFAULT NULL,
  `id_esquipo` int(15) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla contro_siret.tmp: ~0 rows (aproximadamente)

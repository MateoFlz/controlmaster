...
INSERT INTO `acceso` (`id`, `usuarios_id`, `contraseña`, `estado`, `tipo`) VALUES
	...
	(2, 2, 'c05d27772b1b0c91eb9421d578eed65f', 0, 'Administrador'),
...
INSERT INTO `equipos` (`id`, `serial`, `etiqueta_id`, `marca`, `modelo`, `descripcion`, `ubicacion`, `estado`, `activo`) VALUES
	...
	(8, 'UYSD', 7, 'LEVITONS', 'SDY', 'Breve', 1, 'Bueno', 1);
...
-- Volcando datos para la tabla contro_siret.loggback: ~12 rows (aproximadamente)
/*!40000 ALTER TABLE `loggback` DISABLE KEYS */;
INSERT INTO `loggback` (`id`, `detalles`, `fecha`, `id_usuario`, `activo`) VALUES
	(29, 'db-backup-2020-11-12.sql creado 09:54:01 AM', '2020-11-12', 1, 1),
	(30, 'db-backup-2020-11-12.sql creado 09:54:03 AM', '2020-11-12', 1, 0),
	(31, 'db-backup-2020-11-12.sql creado 09:54:44 AM', '2020-11-12', 1, 1),
	(32, 'db-backup-2020-11-12.sql creado 09:54:46 AM', '2020-11-12', 1, 0),
	(33, 'db-backup-2020-11-12.sql creado 10:04:54 AM', '2020-11-12', 1, 0),
	(34, 'db-backup-2020-11-12.sql creado 10:04:58 AM', '2020-11-12', 1, 0),
	(35, 'db-backup-2020-11-12.sql creado 10:05:04 AM', '2020-11-12', 1, 0),
	(36, 'db-backup-2020-11-12.sql creado 10:05:06 AM', '2020-11-12', 1, 0),
	(37, 'db-backup-2020-11-12.sql creado 10:05:07 AM', '2020-11-12', 1, 0),
	(38, 'db-backup-2020-11-12.sql creado 10:05:10 AM', '2020-11-12', 1, 0),
	(39, 'db-backup-2020-11-12.sql creado 10:05:12 AM', '2020-11-12', 1, 0),
	(40, 'db-backup-2020-11-12.sql creado 10:05:14 AM', '2020-11-12', 1, 1),
	(41, 'db-backup-2020-11-12.sql creado 10:05:21 AM', '2020-11-12', 1, 0);
...
-- Volcando datos para la tabla contro_siret.prestamo: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `prestamo` DISABLE KEYS */;
INSERT INTO `prestamo` (`id`, `ubicacion`, `observaciones`, `fecha`, `estado_prestamo`, `id_usuario`, `id_admin`, `ectivo`) VALUES
	(42, 3, 'Prueba nueva', '2020-11-11', 1, 26, 1, 1),
	(43, 1, 'Prueba utilidades', '2020-11-11', 1, 1, 1, 1),
	(44, 3, 'Prueba utilidad y cantidades', '2020-11-11', 1, 1, 1, 1),
	(45, 1, 'OBSERVACION PRUEBA', '2020-11-12', 1, 1, 1, 1);
...
-- Volcando datos para la tabla contro_siret.prestamo_equipo: ~2 rows (aproximadamente)
...
INSERT INTO `prestamo_equipo` (`id`, `prestamo_id`, `equipo_id`, `fecha_entrega`, `fecha_devolucion`, `hora_entrega`, `hora_final`, `recive`, `estado`, `activo`) VALUES
	(36, 42, 6, '2020-11-11', '2020-11-12', '20:57:38 PM', '21:14:54 PM', 'Mateo  Florez Arroyo', 0, 1),
	(37, 42, 5, '2020-11-11', '', '20:57:38 PM', '', '', 1, 1),
	(38, 44, 7, '2020-11-11', '', '21:22:46 PM', '', '', 1, 1);
...
-- Volcando datos para la tabla contro_siret.prestamo_utilidad: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `prestamo_utilidad` DISABLE KEYS */;
INSERT INTO `prestamo_utilidad` (`id`, `prestamo_id`, `utilidad_id`, `fecha_entrega`, `fecha_devolucion`, `hora_entrega`, `hora_final`, `cantidad`, `recive`, `estado`, `activo`) VALUES
	(6, 43, 2, '2020-11-11', '', '21:05:45 PM', '', 2, '', 1, 1),
	(7, 44, 1, '2020-11-11', '', '21:22:46 PM', '', 2, '', 1, 1),
	(8, 45, 2, '2020-11-12', '', '21:44:50 PM', '', 1, '', 1, 1),
	(9, 45, 3, '2020-11-12', '', '21:44:50 PM', '', 1, '', 1, 1),
	(10, 45, 1, '2020-11-12', '', '21:44:50 PM', '', 1, '', 1, 1);
...
-- Volcando datos para la tabla contro_siret.tmp_utilidad_id: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla contro_siret.utilidades: ~4 rows (aproximadamente)
...
INSERT INTO `utilidades` (`id`, `etiqueta_id`, `marca`, `descripcion`, `ubicacion`, `cantidad`, `estado`, `activo`) VALUES
	(1, 4, 'TOR', 'Ninguna', 1, 0, 'Bueno', 1),
	(2, 3, 'PRO', 'Consequat Con sonido', 1, 1, 'Bueno', 1),
	(3, 4, 'Gines', 'Compatible con Hp', 1, 1, 'Bueno', 1),
	(4, 4, 'LEVITON', 'Compatible con lenovo', 1, 1, 'Bueno', 1);

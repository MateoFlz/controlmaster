...
INSERT INTO `prestamo` (`id`, `ubicacion`, `observaciones`, `fecha`, `estado_prestamo`, `id_usuario`, `id_admin`, `ectivo`) VALUES
	(35, 1, 'Descripcion', '2020-11-11', 1, 2, 1, 1),
	(36, 3, 'Para practica en AMC1', '2020-11-11', 1, 2, 1, 1),
	(37, 1, 'Para pruba de PDF prestamo', '2020-11-11', 1, 1, 1, 1),
	(38, 2, 'Utilidad 3', '2020-11-11', 1, 2, 1, 1),
	(39, 5, 'Prueba dos', '2020-11-11', 1, 1, 1, 1),
	(40, 3, 'Prueba', '2020-11-11', 1, 26, 1, 1);
...
INSERT INTO `prestamo_equipo` (`id`, `prestamo_id`, `equipo_id`, `fecha_entrega`, `fecha_devolucion`, `hora_entrega`, `hora_final`, `recive`, `estado`, `activo`) VALUES
	(32, 37, 6, '2020-11-11', '', '17:43:24 PM', '', '', 1, 1),
	(33, 37, 7, '2020-11-11', '', '17:43:24 PM', '', '', 1, 1),
	(34, 37, 1, '2020-11-11', '', '17:43:24 PM', '', '', 1, 1),
	(35, 40, 3, '2020-11-11', '', '18:03:18 PM', '', '', 1, 1);
...
-- Volcando datos para la tabla contro_siret.prestamo_utilidad: ~1 rows (aproximadamente)
...
INSERT INTO `prestamo_utilidad` (`id`, `prestamo_id`, `utilidad_id`, `fecha_entrega`, `fecha_devolucion`, `hora_entrega`, `hora_final`, `recive`, `estado`, `activo`) VALUES
	(2, 36, 2, '2020-11-11', '', '05:12:56 AM', '', '', 1, 1),
	(3, 36, 1, '2020-11-11', '', '05:57:49 AM', '', '', 1, 1),
	(4, 38, 1, '2020-11-11', '', '17:44:06 PM', '', '', 1, 1),
	(5, 39, 3, '2020-11-11', '', '17:45:37 PM', '', '', 1, 1);
...
INSERT INTO `utilidades` (`id`, `etiqueta_id`, `marca`, `descripcion`, `ubicacion`, `cantidad`, `estado`, `activo`) VALUES
	...
	(2, 3, 'PRO', 'Consequat Con sonido', 1, 0, 'Bueno', 1),
